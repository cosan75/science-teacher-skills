...
1. **Subject.** Determine the subject from the prompt and any prior conversation, then look
   ...
   | 통합교과 | 초1–2 바른 생활·슬기로운 생활·즐거운 생활, 놀이·주제 중심 (건강한 생활 `[2건…]`은 2028 적용 예정 — 범위 밖), `[2바…]`·`[2슬…]`·`[2즐…]` | `references/integrated.md` | ready |
   ...
   - **planned** (파일이 아직 없음) → **범위 밖으로 처리한다.** 교사에게 알린다(예:
     *"영어 수업 설계는 아직 준비 중이에요 — 지금은 과학과 초등 사회·국어·수학·통합교과 수업을 완전히 지원해요."*). 이 스킬
