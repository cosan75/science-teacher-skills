...
> 이식), **초등 국어**(초1–6, [korean-teacher-skills](https://github.com/pblsketch/korean-teacher-skills)에서 이식), **초등 수학**(초1–6, 이 포크에서 작성)입니다.
...
| 6 | (포크) 과목별 레퍼런스 — 초등 사회·국어 ✅(이식)·초등 수학 ✅(작성) — 2026-09-23, 다음 권장 통합교과 → 영어 | 🟡 |
