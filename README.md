...
> 지금 완전히 지원하는 과목은 **과학**, **초등 사회**(초3–6, [social-teacher-skills](https://github.com/newskool4d-sketch/social-teacher-skills)에서
> 이식), **초등 국어**(초1–6, [korean-teacher-skills](https://github.com/pblsketch/korean-teacher-skills)에서 이식), **초등 수학**(초1–6)·**통합교과**(초1–2, 바른·슬기로운·즐거운 생활) — 둘은 이 포크에서 작성 — 입니다.
> 중고 수학·중고 국어·중고 사회·도덕·영어·실과·통합교과·체육·음악·미술은 과목 레지스트리에 `planned`로 등록되어 있고, 하나씩 켜 나갑니다 — 준비되지 않은
...
원본에서 바꾼 것은 네 지점입니다 — 표준 조회(Learning Commons Knowledge Graph → 한국 학습맵
MCP), 과목 pedagogy(NGSS 3차원 → 2022 개정 내용 체계 3범주), 교사 대면 언어, 교사 전달
형식(docx → 한글 HWPX). 산출 스키마와 내부 HTML 렌더러는 원본 그대로라 업스트림을 계속
추적할 수 있습니다.
...
| 6 | (포크) 과목별 레퍼런스 — 초등 사회·국어 ✅(이식)·초등 수학·통합교과 ✅(작성) — 2026-09-23, 다음 권장 영어 → 도덕 | 🟡 |
